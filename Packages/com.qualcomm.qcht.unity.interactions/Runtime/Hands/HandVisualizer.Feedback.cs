...
namespace QCHT.Interactions.Hands
{
    ...
    public partial class HandVisualizer
    {
        ...
        private List<UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor> _interactors = new List<UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor>();

        private readonly List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable> _selectedInteractables = new List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable>();
        private readonly List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable> _hoveredInteractables = new List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable>();
        ...
        {
            _interactors = new List<UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor>();
        ...
        {
            var interactable = arg.interactableObject as UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable;
        ...
        {
            var baseInteractable = arg.interactableObject as UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable;
