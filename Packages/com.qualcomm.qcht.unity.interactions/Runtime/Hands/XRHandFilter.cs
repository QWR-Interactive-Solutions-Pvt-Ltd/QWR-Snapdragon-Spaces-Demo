...
namespace QCHT.Interactions.Hands
{
    ...
    public class XRHandFilter : MonoBehaviour, IXRSelectFilter, IXRHoverFilter
    {
        ...
        {
            var xrBaseInteractor = interactor as UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor;
        ...
        private bool FilterHandedness(UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor interactor)
        {
            var hand = interactor.GetComponentInParent<IHandedness>();
            return hand == null || CheckHand(hand.Handedness);
        }

        private bool FilterHandGesture(UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor interactor)
        {
