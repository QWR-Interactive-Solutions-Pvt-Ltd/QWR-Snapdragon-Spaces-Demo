...
namespace QCHT.Interactions.Proximal
{
    ...
    public class XRHandInteractableSnapPoseProvider : XRBaseGrabTransformer
    {
        ...
        {
            interactable = interactable ? interactable : GetComponentInParent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>(true);
        ...
        protected void OnSelectEntered(SelectEnterEventArgs args)
        {
            ...
            var interactor = args.interactorObject as UnityEngine.XR.Interaction.Toolkit.Interactors.XRDirectInteractor;
            if (interactor == null)
                return;
        ...
        private void UpdateTarget(UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable grabInteractable, ref Pose targetPose)
        {
            FindHandTrackingSubsystem();
