...
{
    [RequireComponent(typeof(UnityEngine.XR.Interaction.Toolkit.Interactors.XRPokeInteractor))]
    public class XRPokeReticle : MonoBehaviour
    {
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRPokeInteractor _pokeInteractor;
        ...
        private void Awake()
        {
            _pokeInteractor = GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRPokeInteractor>();
        }
