...
{
    public class XRInteractionGrid : UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable
    {
        ...
        private UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable _currentHandle;
        ...
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor _rayRight;
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor _rayLeft;
        ...
        protected override void OnHoverEntered(HoverEnterEventArgs args)
        {
            ...
            var ray = args.interactorObject as UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor;
        ...
        private void OnHandleSelectEntered(UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable handle)
        {
            Select();
        }

        private void OnHandleSelectedExited(UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable handle)
        {
            Deselect();
        }

        private void OnHandleHoveredEntered(UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable handle)
        {
            _currentHandle = handle;
        }

        private void OnHandleHoveredExited(UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable handle)
        {
            _currentHandle = null;
        }
        ...
        internal static XrHandedness GetInteractorHandedness(UnityEngine.XR.Interaction.Toolkit.Interactors.IXRInteractor xrInteractor)
        {
            if (xrInteractor is UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInputInteractor interactor)
            {
