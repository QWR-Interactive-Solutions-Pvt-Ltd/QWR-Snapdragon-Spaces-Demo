    ...
    public class XRRayInteractorLineVisual : MonoBehaviour
    {
        ...
        private void OnSelectEntered(SelectEnterEventArgs selectEnterEvent)
        {
            ...
            if (_rayInteractor.TryGetCurrent3DRaycastHit(out var raycastHit))
            {
                ...
                var baseInteractor = _rayInteractor as UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor;
                        ...
                        out var interactable, out var snapVolume))
                {
                    ...
                    else if (interactable is UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable grabbable && grabbable.useDynamicAttach)
