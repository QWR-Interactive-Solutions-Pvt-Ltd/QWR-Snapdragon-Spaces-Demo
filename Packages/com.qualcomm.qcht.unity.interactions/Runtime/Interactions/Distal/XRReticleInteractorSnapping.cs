...
namespace QCHT.Interactions.Distal
{
    public class XRReticleInteractorSnapping : MonoBehaviour
    {
        ...
        private UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor _baseInteractor;
        ...
        private void Awake()
        {
            _baseInteractor = GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor>();
            InstantiateReticle();
        }
        ...
        {
            if (((UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor) _baseInteractor).TryGetCurrentRaycast(
                    out var raycastHit,
        ...
        private bool CheckSnapping()
        {
            ...
            ((UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor) _baseInteractor).GetLinePoints(ref linePoints, out _);
            ((UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor) _baseInteractor).TryGetCurrent3DRaycastHit(out raycastHit);
